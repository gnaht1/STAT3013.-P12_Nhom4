...
# Tạo hàm để huấn luyện mô hình, in summary và dự đoán giá bạc 30 ngày tiếp theo
...
print("Dự đoán giá bạc 30 ngày tiếp theo cho tỷ lệ 7:2:1:")
print(next_30_days_7_2_1)

print("Dự đoán giá bạc 30 ngày tiếp theo cho tỷ lệ 6:3:1:")
print(next_30_days_6_3_1)

print("Dự đoán giá bạc 30 ngày tiếp theo cho tỷ lệ 5:3:2:")
...
plot_predictions <- function(original_data, next_30_days, title) {
  ggplot() +
    ...
    labs(title = title, x = "Index", y = "Silver")
}

# Vẽ đồ thị cho từng tỷ lệ chia
plot_predictions(df, next_30_days_7_2_1, "Silver price for the next 30 days (Scale 7:2:1)")
plot_predictions(df, next_30_days_6_3_1, "Silver price for the next 30 days (Scale 6:3:1)")
plot_predictions(df, next_30_days_5_3_2, "Silver price for the next 30 days (Scale 5:3:2)")
